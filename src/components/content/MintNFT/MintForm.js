    ...
    <form onSubmit={submissionHandler}>
      <div className="row justify-content-center">
        <div className="col-md-2">
          <input
            type="text"
            className={`${nameClass} mb-1 generate-border`}
            placeholder="Name..."
            value={enteredName}
        ...
        <div className="col-md-6">
          <input
            type="text"
            className={`${descriptionClass} mb-1 generate-border`}
        ...
        <div className="col-md-2  ">
          <input
            type="file"
            className={`${fileClass} mb-1 generate-border`}
      ...
      <button
        type="submit"
        className="btn btn-lg generate-color  text-white btn-block"
      >
        MINT
      </button>
    </form>
