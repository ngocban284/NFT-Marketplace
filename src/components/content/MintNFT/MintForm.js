...
const MintForm = ()=>{
    ...
    const submissionHandler = (event)=>{
        ...
        const formIsValid = nameIsValid && descriptionIsValid && fileIsValid;
        ...
        const mintNFT = async()=>{
            ...
            if (!metadataAdded) {
                console.error('Something went wrong when updloading the metadata');
                return;
            }

            collectionCtx.contract.methods.safeMint(metadataAdded.path).send({from:web3Ctx.acccount})
